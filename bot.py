...
# --- Vercel Webhook রুট (HTML সাপোর্ট এবং ফিক্স সহ) ---
@app.route("/", methods=["GET", "POST"])
def telegram_webhook():
    import asyncio
    
    # ব্রাউজারে মেইন ডোমেইন লোড করলে গ্লাস ইউআই দেখাবে
    if request.method == "GET":
        try:
            with open("index.html", "r", encoding="utf-8") as f:
                return f.read(), 200
        except FileNotFoundError:
            return "Xtreme Support Bot Website is online!", 200

    # বোটে মেসেজ পাঠালে বা কাস্টমার সিলেক্ট করলে কাজ করবে
...
# মেথড এরর ফিক্স করা আপডেটেড ডাইনামিক সেট-ওয়েবহুক রুট
